                        ...
                        <div class="card">
                            ...
                            <div class="card-body">
                                @if ($errors->any())
                                    ...
                                    @endforeach
                                @endif
                                <form action="{{ route('galeri.update', $galeri->id) }}" method="post" enctype="multipart/form-data" class="needs-validation" novalidate>
                                    @csrf
                                    @method('PUT')
                                    ...
                                    <div class="form-group row mb-4">
                                        <label for="gambar" class="col-form-label text-md-right col-12 col-md-3">Gambar Baru (Opsional)</label>
                                        <div class="col-12 col-md-7">
                                    ...
                                    <div class="form-group row mb-4">
                                        <label for="keterangan" class="col-form-label text-md-right col-12 col-md-3">Keterangan</label>
                                        <div class="col-12 col-md-7">
