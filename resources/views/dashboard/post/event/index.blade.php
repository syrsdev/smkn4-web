										...
										<tbody>
											@foreach ($event as $item)
												<tr>
													...
													<td>
														<a href="{{ route('post.show', $item->slug) }}" class="btn btn-sm btn-secondary" data-toggle="tooltip" data-placement="top" title="Lihat Event">
															<i class="fas fa-eye"></i>
														</a>
														<a href="{{ route('post.edit', $item->slug) }}" class="btn btn-sm btn-warning" data-toggle="tooltip" data-placement="top" title="Edit Event">
															<i class="fas fa-edit"></i>
														</a>
														<a href="{{ route('post.destroy', $item->slug) }}" class="btn btn-sm btn-danger" data-confirm-delete="true"  data-toggle="tooltip" data-placement="top" title="Hapus Event">
