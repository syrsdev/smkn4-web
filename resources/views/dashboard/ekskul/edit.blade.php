        ...
        <section class="section">
            ...
            <div class="section-body">
                ...
                <p class="section-lead">
                    Di halaman ini Anda dapat mengedit Data Ekstrakurikuler dengan mengisi semua kolom.
                </p>
                <div class="row">
                    <div class="col-12">
                        <div class="card">
                            ...
                            <div class="card-body">
                                @if ($errors->any())
                                    ...
                                    @endforeach
                                @endif
                                <form action="{{ route('ekskul.update', $ekskul->slug) }}" method="post" enctype="multipart/form-data" class="needs-validation" novalidate>
                                    @csrf
                                    @method('PUT')
                                    <div class="form-group row mb-4">
                                        <label class="col-form-label text-md-right col-12 col-md-3">Logo</label>
                                        <div class="col-12 col-md-7">
                                            <img src="{{ asset($ekskul->gambar) }}" alt="{{ $ekskul->nama }}" style="width: 250px">
                                        </div>
                                    </div>
                                    <div class="form-group row mb-4">
                                        <label for="nama" class="col-form-label text-md-right col-12 col-md-3">Nama Ekstrakurikuler</label>
                                        <div class="col-12 col-md-7">
                                            <input type="text" class="form-control" id="nama" name="nama" value="{{ $ekskul->nama }}" required autofocus>
                                        </div>
                                    </div>
                                    <div class="form-group row mb-4">
                                        <label for="link_sosmed" class="col-form-label text-md-right col-12 col-md-3">Link Sosmed</label>
                                        <div class="col-12 col-md-7">
                                            <input type="text" class="form-control" id="link_sosmed" name="link_sosmed" value="{{ $ekskul->link_sosmed }}">
                                        </div>
                                    </div>
                                    <div class="form-group row mb-4">
                                        <label class="col-form-label text-md-right col-12 col-md-3">Logo Baru (Opsional)</label>
                                        <div class="col-12 col-md-7">
