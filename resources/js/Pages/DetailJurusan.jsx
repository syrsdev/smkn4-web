    ...
    return (
        ...
        >
            <Container classname="my-10">
                <h1 className="font-bold text-center text-primary text-[18px] md:text-[20px] xl:text-[24px]">
                ...
                <img
                    ...
                    className="w-full max-h-[200px] md:max-h-[250px] xl:max-h-[400px] object-cover mt-5 rounded-2xl"
                />
