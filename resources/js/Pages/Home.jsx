...
function Home(props) {
    ...
    return (
        <LandingLayout subnav={props.subNavbar}>
            <Container
                classname={
                    "flex py-10 lg:items-start text-secondary justify-center flex-col xl:min-h-[530px] bg-fixed bg-center bg-[url('images/hero.png')] bg-no-repeat relative"
                }
            >
