        ...
        >
            <Container classname="mb-14">
                ...
                {props.jurusan.map((item, index) => (
                    <div
                        key={index}
                        className="flex flex-col items-center w-full gap-3 my-6 md:justify-start md:gap-5 xl:gap-8 md:flex-row md:odd:flex-row-reverse"
                    >
                        <img
                            src={item.gambar}
                            className="w-full md:w-[300px] xl:w-[400px] max-h-[166px] md:max-h-[200px] xl:max-h-[270px] object-cover"
                            alt="gambar jurusan"
                        />
